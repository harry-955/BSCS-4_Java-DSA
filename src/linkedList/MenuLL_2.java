...
public class MenuLL_2 {
  ...
  public static void main(String[] args) {
    /*
     * Few Features work on lists with only integer type values in them, Create lists and operate carefully
     */
    ...
    while (ch != 21) {
      ...
      switch (ch) {
        ...
        case 14: // merge 2 lists
          ...
          if (listIdx == -1) {
            System.out.println("First List Doesn't Exist :( ");
          } else if (listIdx_2 == -1) {
            System.out.println("Second List Doesn't Exist :( ");
          } else {
