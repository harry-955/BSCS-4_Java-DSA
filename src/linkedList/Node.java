...
// There are nodes in a Linked List, so I'm using a separate class for it-----------*/
public class Node {
  ...
  Node(String data) {
    this.data = data;
    // whenever a node is created its next pointer is null, assume that it is the last node
    this.next = null;
  }
}
